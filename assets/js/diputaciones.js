...
function combo_distrito() {
  ...
  if (x==1) {
   window.location.href='./diputaciones_distrito.html';  
  }    
}
 ...
 function combo_seccion() {
  ...
  if (x==1) {
   window.location.href='./diputaciones_distrito_seccion.html';  
  } 
}
 ...
 function combo_casilla() {
  ...
  if (x==1) {
   window.location.href='./diputaciones_distrito_casilla.html';  
  } 
}
...
function combo_distrito_ppc() {
  ...
  if (x==1) {
   window.location.href='./diputaciones_distrito_ppc.html';  
  }    
}
